...
exports.default = {
    ...
    async listConditionInducers() {
        ...
        const conditionInducerService = await appium_ios_device_1.services.startInstrumentService(this.opts.device.udid);
        try {
    ...
    async enableConditionInducer(conditionID, profileID) {
        ...
        // @ts-expect-error - do not assign arbitrary properties to `this.opts`
        this._conditionInducerService = await appium_ios_device_1.services.startInstrumentService(this.opts.device.udid);
