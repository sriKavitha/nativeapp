...
declare namespace _default {
     ...
     * @this {XCUITestDriver}
     */
    function pushFile(this: import("../driver").default, remotePath: string, base64Data: string): Promise<void>;
    /**
     * Pushes the given data to a file on the remote device.
     *
     ...
     * @this {XCUITestDriver}
     */
    function mobilePushFile(this: import("../driver").default, remotePath: string, payload: string): Promise<void>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function pullFile(this: import("../driver").default, remotePath: string): Promise<string>;
    /**
     * Pulls a remote file from the device.
     *
     * @param {string} remotePath - The full path to the remote file
     ...
     * @this {XCUITestDriver}
     */
    function mobilePullFile(this: import("../driver").default, remotePath: string): Promise<string>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileDeleteFolder(this: import("../driver").default, remotePath: string): Promise<void>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileDeleteFile(this: import("../driver").default, remotePath: string): Promise<void>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function pullFolder(this: import("../driver").default, remotePath: string): Promise<string>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobilePullFolder(this: import("../driver").default, remotePath: string): Promise<string>;
}
