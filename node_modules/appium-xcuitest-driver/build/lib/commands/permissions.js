...
exports.RESOURCE_NAME_TO_ID_MAP = void 0;
 ...
 */
exports.RESOURCE_NAME_TO_ID_MAP = {
    calendar: 2,
    camera: 6,
    contacts: 1,
    health: -0x40000003,
...
exports.default = {
    ...
    async mobileResetPermission(service) {
        ...
        if (lodash_1.default.isString(service)) {
            resource = exports.RESOURCE_NAME_TO_ID_MAP[lodash_1.default.toLower(service)];
            if (!resource) {
                throw new Error(`The 'service' value must be one of ` +
                    `${JSON.stringify(lodash_1.default.keys(exports.RESOURCE_NAME_TO_ID_MAP))}`);
            }
        }
