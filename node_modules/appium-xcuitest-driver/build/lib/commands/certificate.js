...
exports.parseCommonName = void 0;
...
exports.default = {
    ...
    async mobileInstallCertificate(content, commonName, isRoot) {
        ...
        if (this.isSimulator()) {
            ...
            const client = new py_ios_device_client_1.default(this.opts.udid);
        ...
        try {
            ...
            try {
                ...
                // @ts-expect-error - do not assign arbitrary properties to `this.opts`
                if (support_1.util.compareVersions(this.opts.platformVersion, '>=', '12.2')) {
