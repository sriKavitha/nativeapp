...
exports.default = {
    ...
    async mobilePerformIoHidEvent(page, usage, durationSeconds) {
        ...
        if (Number.isNaN(page)) {
            throw new driver_1.errors.InvalidArgumentError(`'page' argument must be a valid integer`);
        }
        usage = parseInt(String(usage), 10);
        if (Number.isNaN(usage)) {
            throw new driver_1.errors.InvalidArgumentError(`'usage' argument must be a valid integer`);
        }
