...
const pcapLogger = support_1.logger.getLogger('pcapd');
class TrafficCapture {
    ...
    async start(timeoutSeconds) {
        this.mainProcess = /** @type {import('teen_process').SubProcess} */ (await new py_ios_device_client_1.default(this.udid).collectPcap(this.resultPath));
