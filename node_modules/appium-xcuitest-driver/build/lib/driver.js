...
class XCUITestDriver extends driver_1.BaseDriver {
    ...
    constructor(opts = /** @type {XCUITestDriverOpts} */ ({}), shouldValidateCaps = true) {
        ...
        /*---------+
         | EXECUTE |
         +---------+*/
        this.COMMAND_MAP = commands_1.default.executeExtensions.COMMAND_MAP;
    ...
    async start() {
        ...
        // @ts-expect-error - do not assign arbitrary properties to `this.opts`
        if (lodash_1.default.isEmpty(this.xcodeVersion) && (!this.opts.webDriverAgentUrl || !this.opts.realDevice)) {
        ...
        await this.runReset();
        this.wda = new appium_webdriveragent_1.WebDriverAgent(this.xcodeVersion, this.opts, this.log);
    ...
    async deleteSession() {
        ...
        if (this.isSimulator() && !this.opts.noReset && !!this.opts.device) {
            if (this.lifecycleData.createSim) {
                ...
                // @ts-expect-error - do not assign arbitrary properties to `this.opts`
                await (0, simulator_management_1.shutdownSimulator)(this.opts.device);
                // @ts-expect-error - do not assign arbitrary properties to `this.opts`
    ...
    async determineDevice() {
        ...
        if (this.opts.udid) {
            ...
            const device = await (0, real_device_management_1.getRealDeviceObj)(this.opts.udid);
    ...
    async createSim() {
        ...
        // create sim for caps
        const sim = await (0, simulator_management_1.createSim)(this.opts, platformName);
    ...
    async installOtherApps(otherApps) {
        ...
        for (const otherApp of appPaths) {
            // @ts-expect-error - do not assign arbitrary properties to `this.opts`
            await (0, simulator_management_1.installToSimulator)(this.opts.device, otherApp, undefined, {
                newSimulator: this.lifecycleData.createSim,
            });
        }
    }
