...
# registration with OTP pass and real Passport on DESKTOP BROWSER flow
# Prior to running test, image files need to be saved and available on local machine
# Images needed are -
# front of passport in landscape orientation and
# image of users' face in portrait orientation

class NYlotto(confTest.NYlottoBASE):

    def test_regPPTBrowserSuccess(self):
        # Jira test ticket - https://rosedigital.atlassian.net/browse/NYL-2439
        testemail = self.testemail
        testenv = self.env
        print("TESTING " + testenv + " ENVIRONMENT")
        print("\nChecks successful registration with OTP pass and real passport images on Browser method")
        print('\n----------\n' + 'Test setup')
