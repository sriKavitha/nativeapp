...
# registration with OTP pass and fake Driver's License on DESKTOP BROWSER flow
...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regDLBrowserFail(self):
        ...
        print("\nChecks failed registration with OTP pass and fake Driver's License images on Browser method")
        print('\n----------\n' + 'Test setup')
