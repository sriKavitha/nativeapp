...
# registration with OTP pass and real Driver's License on MOBILE flow
# Images needed are -
...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regDLMobileSuccess(self):
        tester_mobile = self.testermobile
        # Jira test ticket - https://rosedigital.atlassian.net/browse/NYL-2448
        testemail = self.testemail
        testenv = self.env
        print("TESTING " + testenv + " ENVIRONMENT")
        print("\nChecks successful registration with OTP pass and real Driver's License on Mobile method")
        print('\n----------\n' + 'Test setup')
        ...
        # wait for GOOGLE SEARCH button appears on screen
