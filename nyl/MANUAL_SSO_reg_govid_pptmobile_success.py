...
# registration with OTP pass and real Passport on MOBILE flow
# Images needed are -
...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regPPTMobileSuccess(self):
        tester_mobile = self.testermobile
        # Jira test ticket - https://rosedigital.atlassian.net/browse/NYL-2446
        testemail = self.testemail
        testenv = self.env
        print("TESTING " + testenv + " ENVIRONMENT")
        print("\nChecks successful registration with OTP pass and real passport images on Mobile method")
        print('\n----------\n' + 'Test setup')
