...
# registration with OTP pass and fake passport images on MOBILE flow
# Images needed are -
...
class NYlotto(confTest.NYlottoBASE):
    ...
    def test_regPPTMobileFail(self):
        tester_mobile = self.testermobile
        # Jira test ticket - https://rosedigital.atlassian.net/browse/NYL-2404
        testemail = self.testemail
        testenv = self.env
        print("TESTING " + testenv + " ENVIRONMENT")
        print("\nChecks failed registration with OTP pass and fake passport images on Mobile method")
        print('\n----------\n' + 'Test setup')
        ...
        # Choosing Passport and Continue on Mobile
