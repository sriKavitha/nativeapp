...
def fullpage_screenshot(driver, file):
    """ Screenshot capture tool that stitches page sections together into a full page screenshot.
    Takes rectangles that are double the width of the window and the half the height of window
    and combines them into one image file.
    :param driver: Webdriver instance
    :type driver: object
    :param file: name of the returned image file
    :type file: str
    :return:
    """
    ...
    print(file+" screenshot captured from error")
    return True
