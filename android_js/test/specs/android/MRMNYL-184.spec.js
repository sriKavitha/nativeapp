...
const FindRetailersPage = require('../../pages/android/findRetailers-page');

describe('Android app user - Continue as a Guest to verify that a user can access the Find Retailers screen through the nav menu', function () {
    ...
    it('Verify that a user can access the Find Retailers screen through the nav menu', async function() {
        ...
        await HamburgerPage.findRetailersBtn.waitForDisplayed()
        await HamburgerPage.findRetailersBtn.click();
